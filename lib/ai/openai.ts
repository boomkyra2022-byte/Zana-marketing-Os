// Shared OpenAI JSON-mode caller used by ideas/scripts/storyboards generation routes.
// Keeps provider/model/timeout/error-handling consistent (MASTER_PROMPT §24 auditability,
// §28 error handling: timeout + readable error on every AI call).
