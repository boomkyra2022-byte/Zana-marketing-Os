  ...
  return (
    <form action={action} className="space-y-6 max-w-3xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="field-label" htmlFor="preferred_language">Preferred Language</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="field-label" htmlFor="pains">Pains</label>
        ...
        <div>
          <label className="field-label" htmlFor="triggers">Triggers</label>
          <textarea id="triggers" name="triggers" rows={2} defaultValue={arrToCsv(persona?.triggers)} />
        </div>
        <div className="col-span-2">
          <label className="field-label" htmlFor="content_formats">Preferred Content Formats</label>
