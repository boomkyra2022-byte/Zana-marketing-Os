...
const KNOWLEDGE_TYPES = ['PRODUCT', 'PERSONA', 'BRAND', 'CONTENT_RULES', 'WINNING_CREATIVE', 'LEARNINGS'];
    ...
    <form action={action} className="space-y-6 max-w-3xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select id="type" name="type" defaultValue={item?.type ?? 'LEARNINGS'}>
      ...
      <div className="flex gap-3">
        ...
        <a href="/knowledge" className="btn-secondary">ยกเลิก</a>
      </div>
    </form>
  );
}
